  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-evenly">
        <Link href={ROUTE.DOI_BONG.ID.replace(":id", leftTeam?._id!)} className="space-y-2">
          <ServerImage
            src={leftTeam.logo}
            alt={leftTeam.name}
            className="w-40"
        ...
        <Link href={ROUTE.DOI_BONG.ID.replace(":id", rightTeam?._id!)} className="space-y-2">
          <ServerImage
            src={rightTeam.logo}
            alt={rightTeam.name}
            className="w-40"
      ...
      <Link
        href={ROUTE.SAN_BONG.ID.replace(":id", field?._id!)}
